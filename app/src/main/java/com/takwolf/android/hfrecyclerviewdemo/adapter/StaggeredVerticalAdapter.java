...
public class StaggeredVerticalAdapter extends RecyclerView.Adapter<StaggeredVerticalAdapter.ViewHolder> {

    private final Activity activity;
    private final LayoutInflater inflater;
    private final List<Illust> illustList = new ArrayList<>();

    public StaggeredVerticalAdapter(@NonNull Activity activity) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_staggered_vertical, parent, false), activity);
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(@NonNull StaggeredVerticalAdapter adapter, int position) {
