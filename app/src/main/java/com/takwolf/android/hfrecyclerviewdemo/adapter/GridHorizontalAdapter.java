...
public class GridHorizontalAdapter extends RecyclerView.Adapter<GridHorizontalAdapter.ViewHolder> {

    private final Activity activity;
    private final LayoutInflater inflater;
    private final List<Illust> illustList = new ArrayList<>();

    public GridHorizontalAdapter(@NonNull Activity activity) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_grid_horizontal, parent, false), activity);
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private GridHorizontalAdapter adapter;
        ...
        void onBind(@NonNull GridHorizontalAdapter adapter, int position) {
