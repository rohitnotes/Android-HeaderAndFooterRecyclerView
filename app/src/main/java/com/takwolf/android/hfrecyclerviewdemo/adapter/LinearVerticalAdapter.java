...
public class LinearVerticalAdapter extends RecyclerView.Adapter<LinearVerticalAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(activity, inflater.inflate(R.layout.item_linear_vertical, parent, false));
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void update(@NonNull LinearVerticalAdapter adapter, int position) {
