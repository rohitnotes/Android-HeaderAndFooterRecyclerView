...
public class LinearVerticalAdapter extends RecyclerView.Adapter<LinearVerticalAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_linear_vertical, parent, false), activity);
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(@NonNull LinearVerticalAdapter adapter, int position) {
