...
public class LinearHorizontalAdapter extends RecyclerView.Adapter<LinearHorizontalAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(activity, inflater.inflate(R.layout.item_linear_horizontal, parent, false));
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void update(@NonNull LinearHorizontalAdapter adapter, int position) {
