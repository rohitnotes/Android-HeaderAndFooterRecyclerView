...
public class LinearHorizontalAdapter extends RecyclerView.Adapter<LinearHorizontalAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(inflater.inflate(R.layout.item_linear_horizontal, parent, false), activity);
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(@NonNull LinearHorizontalAdapter adapter, int position) {
